...
export default function ProductTableBodyUI({ category, subCategory, product, id, prodIdData, subCatIdData, catIdData }) {
  ...
  console.log(category, subCategory, product, id, prodIdData, subCatIdData, catIdData);
  ...
  const handleUpdateProduct = async (id) => {
    ...
    if (res?.status_code === "200") {
      ...
      const productNameArray =
        resData &&
        resData.productList &&
        resData.productList.map((obj) => obj);
  ...
  return (
    <TableRow hover tabIndex={-1}>
      ...
      <TableCell align="center"><b>{subCategoryText}</b></TableCell>
